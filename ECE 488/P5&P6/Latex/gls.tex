...
\newglossaryentry{ORHP}{name={ORHP}, description={Open Right Hand Plane}}
\newglossaryentry{RHP}{name={RHP}, description={Right Hand Plane}}
\newglossaryentry{LHP}{name={LHP}, description={Left Hand Plane}}
\newglossaryentry{BSI}{name={BSI},description={Bode Sensitivity Integral}}
\newglossaryentry{PoI}{name={PoI},description={Poisson Integral}}