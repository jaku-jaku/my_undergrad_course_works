...
% --- ANS --- %
\begin{answer}[(a) Verify the linearization]{ans:P1-a}
...
\clearpage
\begin{answer}[(b) Compute $W(s)/\tau(s)$]{ans:P1-b}
...
\begin{answer}[(c) Classical Control Design]{ans:P1-c}
...
\clearpage
\begin{answer}[(d) MATLAB : Performance Evaluation]{ans:P1-d}
	{	
	...
	{	
		\centering\includegraphics[width=300px]{../matlab/output/q1/step_response_0p5-Hz}
      	\captionof{figure}{Closed-loop response for a sinusoidal input at $0.5\unit{Hz}$  \label{fig:p1:response:0p5Hz}}
	}
	{	
		\centering\includegraphics[width=300px]{../matlab/output/q1/step_response_2-Hz}
      	\captionof{figure}{Closed-loop response for a sinusoidal input at $2\unit{Hz}$  \label{fig:p1:response:2Hz}}
	}
	{	
		\centering\includegraphics[width=300px]{../matlab/output/q1/step_response_10-Hz}
      	\captionof{figure}{Closed-loop response for a sinusoidal input at $10\unit{Hz}$  \label{fig:p1:response:10Hz}}
	}
	{	
		\centering\includegraphics[width=300px]{../matlab/output/q1/step_response_100-Hz}
      	\captionof{figure}{Closed-loop response for a sinusoidal input at $100\unit{Hz}$  \label{fig:p1:response:100Hz}}
	}
...
\begin{answer}[(b) Bandwidth of the control system]{ans:P2-b}
...
\newpage
\begin{answer}[(c) Robustness analysis of $C_1(s)$]{ans:P2-c}
